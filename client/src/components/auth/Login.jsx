...
const Login = () => {
  ...
  const { login, authError, loginWithGoogle } = useApp();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Check for Firebase password-specific errors
      if (error.code === "auth/wrong-password") {
        setPasswordError("Incorrect password. Please try again.");
      } else if (error.code === "auth/user-not-found") {
        // This is not strictly a password error, but useful for user experience
