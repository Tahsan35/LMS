            ...
            <tr key={index} className="border-b border-gray-500/20">
              <td className="md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <Line strokeWidth={2} percent={progressArray[index].lectureCompleted / progressArray[index].lectureTotal * 100} className="bg-gray-300 rounded-full"></Line>
                </div>
              </td>
              <td className="px-4 py-3 max-sm:hidden">{calculateCourseDuration(course)}</td>
              <td className="px-4 py-3 max-sm:hidden">
                {progressArray[index].lectureCompleted} / {progressArray[index].lectureTotal}{" "}
                <span>Lectures</span>
              </td>
